...
<html lang="es">
    ...
    <body>
        ...
        <main>
            <figure>
                <img src="imagenes/bodegon.jpg" class="imagenobra" alt="Imagen de bodegon">
            </figure>
            <section class="fichayobra">
                ...
                <aside class="obrasrelacionadas">
                    <nav >
                        ...
                        <ul>
                            <li><a href="obra1.html">Obra 1</a></li>
                            <li><a href="obra1.html">Obra 2</a></li>
                            <li><a href="obra1.html">Obra 3</a></li>
                            <li><a href="obra1.html">Obra 4</a></li>
                            <li><a href="obra1.html">Obra 5</a></li>
                        </ul>
                    </nav>
                </aside>
            </section>
        ...
        <footer>
            ...
            <a href="como_se_hizo.pdf" target="_blank" id="documentacion">Cómo se hizo</a>
        </footer>
    </body>
</html>